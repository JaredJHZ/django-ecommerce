...
from .models import Item, Order, OrderItem, Payment, Address, Coupon
...
class OrderAdmin(admin.ModelAdmin):
    list_display = ['user', 'ordered', 'being_delivered', 'received','refund_requested', 'refund_granted','payment','coupon' ,'shipping_address']
...
class AddressAdmin(admin.ModelAdmin):
    list_display = ['user', 'street_address', 'suburb', 'country','zip','address_type','default']
